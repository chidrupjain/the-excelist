  ...
  return (
    <div className="min-h-screen bg-white py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-navy-800 mb-8 border-b pb-4">Privacy Policy</h1>
        
        <div className="space-y-6 text-gray-700 leading-relaxed text-sm text-justify">
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">PERSONAL INFORMATION</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">INFORMATION WE COLLECT</h2>
          <p>
          ...
          <p className="font-semibold mt-4">Personal Identifiable Information:</p>
          <p>
          ...
          <p className="font-semibold mt-4">Non-Personal Identifiable Information:</p>
          <p>
          ...
          <p className="font-semibold mt-4">Cookies:</p>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">HOW WE USE AND SHARE THE INFORMATION COLLECTED</h2>
          <p>We may collect and use Your Personal Information for the following purposes:</p>
          
          <p className="font-semibold mt-2">To provide access to our Platform and/or the services/products offered therein:</p>
          <p>
          ...
          <p className="font-semibold mt-2">To improve our Platform and maintain safety:</p>
          <p>
          ...
          <p className="font-semibold mt-2">To communicate with You or market our services/products:</p>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">YOUR CHOICES</h2>
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>Limit the information You provide:</strong> You always have an option to choose the information You provide to us, including the option to update or delete Your information. However, please note that lack of certain information may not allow You access to the Platform or any of its features, in part or in full. For example: information required for Your registration on the Platform.</li>
            <li><strong>Limit the communications You receive from us:</strong> Further, You will also have the option to choose what kind of communication You would like to receive from us. However, there may be certain communications that are required for legal or security purposes, including changes to various legal agreements, that you may not be able to limit.</li>
            <li><strong>Reject Cookies and other similar technologies:</strong> You may reject or remove cookies from Your web browser; You will always have the option to change the default settings on Your web browser if the same is set to ‘accept cookies’. However, please note that some of the services/products offered on the Platform may not function or be available to You, when the cookies are rejected, removed or disabled.</li>
          </ul>

          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">YOUR RIGHTS</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">PROTECTION OF YOUR INFORMATION</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">THIRD PARTY WEBSITES</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">CROSS-BORDER DATA TRANSFER</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">DURATION FOR WHICH YOUR INFORMATION IS STORED</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">MODIFICATION TO PRIVACY POLICY</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">GRIEVANCES</h2>
          <p>
            If you have any questions about this Policy, wish to exercise your rights, concerns about privacy or grievances, please write to us with a thorough description via email to <a href="mailto:deepak43545566@mailinator.com" className="text-blue-600 underline">deepak43545566@mailinator.com</a>.
          </p>

          <hr className="my-12 border-gray-200" />

          <h2 className="text-2xl font-bold text-navy-900 mb-6">COUNTRY SPECIFIC ADDITIONAL RIGHTS</h2>
          
          <h3 className="text-lg font-bold text-navy-800 mt-6 mb-2">TERMS APPLICABLE IF YOU ARE AN INDIAN RESIDENT</h3>
          <p>
          ...
          <h3 className="text-lg font-bold text-navy-800 mt-8 mb-2">TERMS APPLICABLE IF YOU ARE A RESIDENT OF UNITED KINGDOM (UK), A EUROPEAN UNION (EU) COUNTRY OR EUROPEAN ECONOMIC AREA (EEA)</h3>
          <p>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-2">
            ...
            <li><strong>Right to make a complaint to a government supervisory authority:</strong> If you believe we have not processed your Personal Information in accordance with applicable provisions of the GDPR, we encourage you to contact us at email address provided in the ‘Grievances’ section above. You also have the right to make a GDPR complaint to the relevant Supervisory Authority or seek a remedy through the courts.</li>
          ...
          <h3 className="text-lg font-bold text-navy-800 mt-8 mb-2">TERMS APPLICABLE IF YOU ARE A CALIFORNIA STATE RESIDENT</h3>
          <p>
          ...
          <h4 className="font-semibold mt-4">CCPA NOTICE AT COLLECTION:</h4>
          ...
          <ul className="list-disc pl-5 space-y-1">
             <li>Identifiers: We may collect your name, email address, mobile number, username, unique personal identifier, and Internet Protocol (IP) address.</li>
             <li>Characteristics of Personal Information described in the California Customer Records statute: We may collect your name, email address, username, unique personal identifier, and gender.</li>
             <li>Internet or other electronic network activity information: We collect cookies as described above.</li>
             <li>Geolocation data: We may collect your IP address.</li>
             <li>Audio, electronic, visual or similar information: We may collect your profile picture or other audio or visual information uploaded as content to the Platform.</li>
             <li>Inferences: We may make inferences based upon the Personal Information collected (such as likelihood of retention or attrition).</li>
          </ul>

          <h4 className="font-semibold mt-4">CCPA DATA PRACTICES DURING THE LAST 12 MONTHS:</h4>
          <p>We have collected, but not sold, the following categories of Personal Information during the preceding 12 months:</p>
          <ul className="list-disc pl-5 space-y-1">
            <li>Identifiers</li>
          ...
          <h4 className="font-semibold mt-4">CONSUMER RIGHTS AND REQUESTS UNDER THE CCPA</h4>
          <p>
          ...
          <p className="mt-2"><strong>Request to Know:</strong> As a California resident, you have the right to request details about the Personal Information we have collected, used, and disclosed over the past 12 months.</p>
          
          <p className="mt-2"><strong>Request to Delete:</strong> As a California resident, you have a right to request the erasure/deletion of certain Personal Information collected or maintained by us, subject to certain legal exemptions.</p>

          <p className="mt-2"><strong>Submitting a Request:</strong> You may submit a request to know or to delete by email to the address provided in the ‘Grievances’ section above.</p>
          
          <p className="mt-2"><strong>CCPA Non-Discrimination:</strong> You have the right not to receive discriminatory treatment by us due to your exercise of the rights provided by the CCPA.</p>
