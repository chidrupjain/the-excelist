  ...
  return (
    <div className="min-h-screen bg-white py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-navy-800 mb-8 border-b pb-4">Terms of Use</h1>
        
        <div className="space-y-6 text-gray-700 leading-relaxed text-sm text-justify">
          <p>
            These Terms of Use set out the terms and conditions for use of this The Excelist ( “Website”) and any content, Public Forums, or services offered on or through the Website and/or through any mobile application(s) ( “Application”) (collectively referred to as the “Platform”).
          </p>
          <p>
          ...
          <p>
            When we speak of “Creator”, ‘we’, ‘us’, and ‘our’, we collectively mean The Excelist being the creator of this Platform and the content/materials/services contained therein.
          </p>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">Access and Registration</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">License to Use</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">Communications</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">Feedback</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">Disclaimer</h2>
          <div className="bg-gray-50 p-6 rounded border border-gray-200 uppercase text-xs leading-loose">
            <p className="mb-4">
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">Indemnity and Release</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">Links to Third Party Website</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">Governing Law and Jurisdiction</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">Miscellaneous</h2>
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>Alteration of Platform or Amendments to the Conditions:</strong> We reserve the right to make changes to our Platform, policies, and this Agreement at any time. We will post the new terms with a revision date indicated at the top or if deemed practicable. You should check our Platform frequently to see recent changes. You will be subject to the Agreement and the policies in force at the time that You use the Platform or any part thereof, unless any change to those policies or these conditions is required to be made by law or government authority (in which case it will apply to orders previously placed by You). If any of these conditions is deemed invalid, void, or for any reason unenforceable, that condition will be deemed severable and will not affect the validity and enforceability of any remaining condition.</li>
            ...
            <li><strong>Assignment:</strong> You may not assign or transfer this Agreement, by operation or law or otherwise. Any attempt by You to assign or transfer this Agreement will be null and void.</li>
            <li><strong>Severability:</strong> If any provision of this Agreement will be adjudged by any court of competent jurisdiction to be unenforceable or invalid, that provision will be limited to the minimum extent necessary so that this Agreement will otherwise remain in effect.</li>
            <li><strong>Events beyond our reasonable control:</strong> We will not be held responsible for any delay or failure to comply with our obligations under these conditions if the delay or failure arises from any cause which is beyond our reasonable control. This condition does not affect Your statutory rights.</li>
          </ul>

          <h2 className="text-xl font-bold text-navy-800 mt-8 mb-4">Contact Us</h2>
          <p>
            If You’ve have concerns or queries regarding this Agreement, You may write to us by email at <a href="mailto:info@theexcelist.com" className="text-blue-600 underline">info@theexcelist.com</a>.
          </p>
